...
export default function PublicPage() {
  ...
  return (
    <main className="min-h-dvh overflow-x-hidden bg-white px-3 py-5 sm:px-6 sm:py-8">
      <div className="mx-auto w-full max-w-5xl">
        <h1 className="text-balance text-center text-xl font-bold text-blue-700 sm:text-3xl">
